...
// ********** Register Plugins **********
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_CSSRulePlugin__WEBPACK_IMPORTED_MODULE_1__.CSSRulePlugin, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger, gsap_DrawSVGPlugin__WEBPACK_IMPORTED_MODULE_3__.DrawSVGPlugin, gsap_SplitText__WEBPACK_IMPORTED_MODULE_4__.SplitText);
...
function imageSwipeInExportFunction() {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set('.swipe-in-image', { clipPath: 'inset(0% 100% 0% 0%)' });

  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.batch('.swipe-in-image', {
    start: 'top 60%',
    end: 'bottom bottom',
    id: 'Swipe In Image',
    // markers: true,
    once: true,
    onEnter: (batch) => gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(batch, { duration: 0.75, ease: 'circ.inOut', clipPath: 'inset(0% 0% 0% 0%)' }),
  });
}
...
function simpleFadeIn() {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set('.simple-fade-in', { opacity: 0 });

  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.batch('.simple-fade-in', {
    start: 'top 75%',
    end: 'bottom bottom',
    id: 'Fade In',
    // markers: true,
    once: true,
    onEnter: (batch) => gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(batch, { duration: 0.75, ease: 'circ.inOut', opacity: 1 }),
  });
}
...
const splitTextHeadings = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.toArray(document.querySelectorAll('.split-text-heading-animation'));
...
function splitTextTimelineFunction(splitElems, evenSplitElems, oddSplitElems, durationTime, delayTime) {
  ...
  const headingAnimationTL = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
    defaults: {
...
function splitTextHeadingsFunction() {
  splitTextHeadings.forEach((headings) => {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(evenSplit, { opacity: 0, y: -20 });
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(oddSplit, { opacity: 0, y: +20 });
...
const splitTextBodyElems = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.toArray(document.querySelectorAll('.split-text-body-animation'));
...
function bodySplitTextAnimation() {
  splitTextBodyElems.forEach((body) => {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(splitLines, { opacity: 0, y: -20 });
    ...
    gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.create({
      ...
      // markers: true,
      onEnter: () =>
        gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(splitLines, {
          opacity: 1,
          y: 0,
          duration: 0.4,
          stagger: 0.05,
...
const circleToAnimate = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.toArray(document.querySelectorAll('.circle-animation'));

// Circle animation function
function circleAnimationfunction() {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(circleToAnimate, { rotate: -45, opacity: 0 });
  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.batch(circleToAnimate, {
    start: 'top 70%',
    end: 'bottom bottom',
    once: true,
    id: 'Circles',
    // markers: true,
    onEnter: (batch) => gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(batch, { opacity: 1, rotate: 0, duration: 0.75, ease: 'circ.inOut' }),
  });
}
...
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(fadeAndSwapNineElement, { clipPath: 'inset(0% 100% 0% 0%)' });

// * Image swapping Function

function fadeAndSwapNineFunction(elem, swapperImages) {
  const faderSwapper = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
...
function fadeAndSwapNineFunctionExport() {
  fadeAndSwapNineElement.forEach((images) => {
    const gsapImages = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.toArray(images.querySelectorAll('img'));
    gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.create({
      trigger: images,
      start: 'top 60%',
      end: 'bottom bottom',
...
// TODO: Do I need this? 👇🏾
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(fadeAndSwapThreeElement, { clipPath: 'inset(0% 100% 0% 0%)' });

// * Image swapping Function

function fadeAndSwapThreeFunction(elem, swapperImages) {
  const faderSwapperThree = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
    defaults: { duration: 0, ease: 'none' },
  });
  const delay = '+=0.4';
...
function svgScrubAnimation() {
  const svgToAnimate = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.toArray(document.querySelectorAll('[data-name="Text"]'));
...
!function() {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2);
/* harmony import */ var gsap_CSSRulePlugin__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5);
/* harmony import */ var gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6);
/* harmony import */ var gsap_DrawSVGPlugin__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7);
/* harmony import */ var gsap_SplitText__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8);
/* harmony import */ var _animations__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _lib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
...
gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.registerPlugin(gsap_CSSRulePlugin__WEBPACK_IMPORTED_MODULE_3__.CSSRulePlugin, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_4__.ScrollTrigger, gsap_DrawSVGPlugin__WEBPACK_IMPORTED_MODULE_5__.DrawSVGPlugin, gsap_SplitText__WEBPACK_IMPORTED_MODULE_6__.SplitText);

(0,_animations__WEBPACK_IMPORTED_MODULE_0__.bodySplitTextAnimation)();
...
// * Circle Animation
(0,_animations__WEBPACK_IMPORTED_MODULE_0__.circleAnimationfunction)();

// * Animated Main Logo
(0,_animations__WEBPACK_IMPORTED_MODULE_0__.animatedMainLogo)();

// * Header Image Animation
(0,_animations__WEBPACK_IMPORTED_MODULE_0__.fadeAndSwapNineFunctionExport)();

// * Fade and Swap Three Animation
(0,_animations__WEBPACK_IMPORTED_MODULE_0__.fadeAndSwapThreeExport)();

// * Image Swipe In
(0,_animations__WEBPACK_IMPORTED_MODULE_0__.imageSwipeInExportFunction)();

// * Split Text Animation For Headings
(0,_animations__WEBPACK_IMPORTED_MODULE_0__.splitTextHeadingsFunction)();

// * Scroll Trigger Refresh
(0,_animations__WEBPACK_IMPORTED_MODULE_0__.scrollTriggerRefresh)(2000);
...
(0,_lib__WEBPACK_IMPORTED_MODULE_1__.consoleGreeting)();
